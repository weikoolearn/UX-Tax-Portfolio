  ...
  return (
    <section className="stack" style={{width: "100%", gap: "3.75rem"}}>
      ...
      >
        ...
        <div
          className="relative h-[360px] w-full overflow-visible rounded-xl border bg-muted/30 p-6 transition hover:shadow-sm"
          aria-hidden="true"
          style={{
            maxWidth: "560px",
            marginRight: "-2rem",
        ...
        >
          <div
            style={{
              ...
              boxShadow: "0 10px 20px color-mix(in srgb, black 6%, transparent)",
              transform: "translateY(14px)",
              opacity: 0,
              animation: "trayIn 0.52s cubic-bezier(0.22, 1, 0.36, 1) 0.3s forwards"
            }}
          >
            <div
              style={{
          ...
          <div
            style={{
              ...
              background: "color-mix(in srgb, var(--background) 99%, white)",
              boxShadow: "0 10px 18px color-mix(in srgb, black 7%, transparent)",
              transform: "translateX(236px) translateY(-106px) rotate(-9deg)",
              opacity: 0,
              animation:
                "docAIn 1.02s cubic-bezier(0.18, 0.9, 0.22, 1) 0.04s forwards, docAIdle 6.8s ease-in-out 3s infinite"
            }}
          >
            <div style={{padding: "0.82rem", display: "grid", gap: "0.4rem"}}>
              <div style={{height: "0.3rem", width: "58%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 70%, transparent)"}} />
              <div style={{height: "0.24rem", width: "82%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 52%, transparent)"}} />
              <div style={{height: "0.24rem", width: "66%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 52%, transparent)"}} />
              <div
                style={{
                  marginTop: "0.12rem",
                  height: "2.38rem",
          ...
          <div
            style={{
              ...
              boxShadow: "0 8px 16px color-mix(in srgb, black 5%, transparent)",
              transform: "translateX(180px) translateY(-54px) rotate(-3deg)",
              opacity: 0,
              animation:
                "docBIn 0.9s cubic-bezier(0.2, 0.92, 0.24, 1) 0.28s forwards, docBIdle 6.2s ease-in-out 3.15s infinite"
            }}
          >
            <div style={{padding: "0.76rem", display: "grid", gap: "0.34rem"}}>
              <div style={{height: "0.28rem", width: "52%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 68%, transparent)"}} />
              <div style={{height: "0.22rem", width: "78%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 50%, transparent)"}} />
              <div style={{height: "0.22rem", width: "62%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 50%, transparent)"}} />
              <div
                style={{
                  marginTop: "0.08rem",
                  height: "1.82rem",
                  borderRadius: "0.38rem",
                  border: "1px dashed color-mix(in srgb, var(--border) 42%, transparent)"
                }}
              />
            </div>
          </div>
          ...
          <div
            style={{
              ...
              opacity: 0,
              animation: "reviewIn 0.34s ease 1.3s forwards"
            }}
          >
            <div style={{padding: "0.7rem", display: "grid", gap: "0.28rem"}}>
              <div style={{height: "0.26rem", width: "58%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 64%, transparent)"}} />
              <div style={{height: "0.22rem", width: "78%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 46%, transparent)"}} />
              <div style={{height: "0.22rem", width: "54%", borderRadius: "999px", background: "color-mix(in srgb, var(--border) 46%, transparent)"}} />
            </div>
          </div>
          ...
          <div
            style={{
              ...
              transform: "scaleX(0)",
              opacity: 0,
              animation: "handoffIn 0.24s ease 1.12s forwards"
            }}
          />
          ...
          <div
            style={{
              ...
              transform: "scaleX(0)",
              opacity: 0,
              animation: "routeLineIn 0.22s ease 1.6s forwards"
            }}
          />
          ...
          <div
            style={{
              ...
              transform: "scaleY(0)",
              opacity: 0,
              animation: "routeStemIn 0.22s ease 1.7s forwards"
            }}
          />
          ...
          <div
            style={{
              ...
              opacity: 0,
              animation: "routeEndpointIn 0.24s ease 1.82s forwards"
            }}
          />
          ...
          <div
            style={{
              ...
              transform: "translateY(6px)",
              opacity: 0,
              animation: "routeEndpointIn 0.24s ease 1.92s forwards"
            }}
          />
          ...
          <style>
            {`@keyframes trayIn {
              ...
              @keyframes docAIn {
                0% { transform: translateX(236px) translateY(-106px) rotate(-9deg) scale(1.02); opacity: 0; }
                62% { transform: translateX(18px) translateY(-8px) rotate(-9deg) scale(1); opacity: 1; }
                80% { transform: translateX(-4px) translateY(5px) rotate(-9deg) scale(0.984); opacity: 1; }
                100% { transform: translateX(0px) translateY(0px) rotate(-9deg) scale(1); opacity: 1; }
              }
              @keyframes docBIn {
                0% { transform: translateX(180px) translateY(-54px) rotate(-3deg); opacity: 0; }
                70% { transform: translateX(10px) translateY(1px) rotate(-3deg); opacity: 0.9; }
                100% { transform: translateX(0px) translateY(0px) rotate(-3deg); opacity: 0.92; }
              }
              @keyframes reviewIn {
              ...
              @keyframes routeStemIn {
                0% { transform: scaleY(0); opacity: 0; }
                100% { transform: scaleY(1); opacity: 1; }
              }
              @keyframes routeEndpointIn {
                0% { transform: translateY(6px); opacity: 0; }
                100% { transform: translateY(0px); opacity: 1; }
              }
              @keyframes docAIdle {
                0%, 100% { transform: translateX(0px) translateY(0px) rotate(-9deg); }
                50% { transform: translateX(0px) translateY(-2px) rotate(-9deg); }
              }
              @keyframes docBIdle {
                0%, 100% { transform: translateX(0px) translateY(0px) rotate(-3deg); }
                50% { transform: translateX(0px) translateY(1px) rotate(-3deg); }
              }`}
          </style>
        </div>
      </section>
