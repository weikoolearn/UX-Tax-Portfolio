export default function TaxIdentityEntryPage() {
  return (
    <section className="stack">
        <header className="page-header" style={{maxWidth: "none"}}>
        ...
        <section className="stack">
          <h2>Identity Ambiguity in Globally Mobile Taxpayers</h2>
          <p>
          ...
          <div className="stack">
            <div className="stack">
              <h3>Transitional Residency Determination</h3>
              <p>
            ...
            <div className="stack">
              <h3>Visa-Linked Filing Complexity</h3>
              <p>
            ...
            <div className="stack">
              <h3>Year-to-Year Identity Shifts</h3>
              <p>
        ...
        <section className="stack">
          <h2>Structural Friction in Identity Routing</h2>
          <p>
            While identity classification appears straightforward at the
            surface level, early-stage routing decisions significantly
            influence downstream filing logic. When classification lacks
            structural clarity, users may experience uncertainty in document
            requirements, filing status paths, and compliance expectations.
          </p>

          <div className="stack">
            <div className="stack">
              <h3>Binary Classification Constraints</h3>
              <p>
                Many systems rely on simplified resident / non-resident
                branching logic. This binary structure may not fully surface
                transitional or treaty-dependent conditions.
              </p>
            </div>

            <div className="stack">
              <h3>Delayed Regulatory Visibility</h3>
              <p>
        ...
        <section className="stack">
          ...
          <p>
            ...
            existing core systems, this proposal introduces a structured
            identity gateway positioned before standard tax filing flows. The
            gateway presents identity-based entry cards, allowing users to
            self-select pathways aligned with their residency and visa
            conditions.
          </p>
          ...
          <div className="stack">
            ...
            <div className="stack">
              ...
              <p>
                ...
                through the standard experience, while internationally
                dependent users enter a specialized pathway designed to surface
                relevant compliance considerations earlier in the process.
              </p>
            </div>
            ...
            <div className="stack">
              ...
              <p>
                ...
                appears progressively, clarifying residency determination,
                treaty implications, and documentation expectations. This layer
                enhances transparency without modifying the underlying tax
                calculation engines.
              </p>
            </div>
          </div>
        ...
        <section className="stack">
          <h2>Identity-Based Filing Routing Architecture</h2>
          ...
          <div className="stack">
            <div className="stack">
              ...
              <p>
                ...
                designed an identity-based routing architecture that detects
                tax residency before users enter the filing flow. This approach
            ...
            <div className="stack">
              ...
              <p>
                ...
                throughout the filing process. Instead of altering the
                underlying tax calculation engine, the system surfaces relevant
                compliance considerations — such as treaty applicability,
                documentation requirements, and visa-specific filing
                implications — at the appropriate stages of the experience.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="stack">
          ...
          <div className="stack">
            ...
            <div className="stack">
              <h3>↓ 28%</h3>
              <p>
                Decrease in identity-related clarification requests during
                early onboarding stages.
              </p>
            </div>
        ...
        <section className="stack">
          ...
          <p>
            ...
            that ambiguity often originates at the entry layer rather than at
            ...
            <div className="stack">
              ...
              <div className="stack">
                ...
                <p>
                  ...
                  dual-status filers to refine identity card definitions and
                  routing clarity based on real-world ambiguity patterns.
                </p>
              </div>
